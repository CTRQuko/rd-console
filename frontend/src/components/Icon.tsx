// Inline lucide-style stroke icons. Single source of truth so every
// page consumes the same sizes / weights. Ported from the Babel-runtime
// version at public/console/icons.jsx as part of the Etapa 4 ESM
// migration (PR 1).
